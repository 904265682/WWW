        ...
        function(a) {
            ...
            function e(a) {
                ...
                d.each(a,
                    function(d) {
                        b = d.match(/^([^A-Z]+?)([A-Z])/),
                        b && -1 !== f.indexOf(b[1] + " ") && (c = d.replace(b[0], b[2].toLowerCase()), g[c] = d, "o" === b[1] && e(a[d]))
                    }),
                    a._hungarianMap = g
            }
            function f(a, b, g) {
            ...
            function g(a) {
                var b = Wb.defaults.oLanguage,
                    c = a.sZeroRecords; ! a.sEmptyTable && c && "No data available in table" === b.sEmptyTable && Lb(a, a, "sZeroRecords", "sEmptyTable"),
                !a.sLoadingRecords && c && "Loading..." === b.sLoadingRecords && Lb(a, a, "sZeroRecords", "sLoadingRecords"),
            ...
            function h(a) {
                sc(a, "ordering", "bSort"),
                    sc(a, "orderMulti", "bSortMulti"),
                    sc(a, "orderClasses", "bSortClasses"),
                    sc(a, "orderCellsTop", "bSortCellsTop"),
                    sc(a, "order", "aaSorting"),
                    sc(a, "orderFixed", "aaSortingFixed"),
                    sc(a, "paging", "bPaginate"),
                    sc(a, "pagingType", "sPaginationType"),
                    sc(a, "pageLength", "iDisplayLength"),
                    sc(a, "searching", "bFilter");
                var b = a.aoSearchCols;
                if (b) for (var c = 0,
                                d = b.length; d > c; c++) b[c] && f(Wb.models.oSearch, b[c])
            }
            function i(a) {
                sc(a, "orderable", "bSortable"),
                    sc(a, "orderData", "aDataSort"),
                    sc(a, "orderSequence", "asSorting"),
                    sc(a, "orderDataType", "sortDataType")
            }
            function j(a) {
                var b = a.oBrowser,
                    c = d("<div/>").css({
            ...
            function n(a) {
                if (a.oFeatures.bAutoWidth !== !1) {
                    ...
                    sb(a);
                    for (var c = 0,
                             d = b.length; d > c; c++) b[c].nTh.style.width = b[c].sWidth
                }
                var e = a.oScroll; ("" !== e.sY || "" !== e.sX) && qb(a),
                    Pb(a, null, "column-sizing", [a])
            }
            function o(a, b) {
                var c = r(a, "bVisible");
            ...
            function s(a) {
                ...
                for (b = 0, d = l.length; d > b; b++) if (i = l[b], k = [], !i.sType && i._sManualType) i.sType = i._sManualType;
                else if (!i.sType) {
            ...
            function t(a, b, e, f) {
                ...
                if (b) for (g = b.length - 1; g >= 0; g--) {
                    ...
                    else if ("string" == typeof p[i]) for (k = 0, m = o.length; m > k; k++)("_all" == p[i] || d(o[k].nTh).hasClass(p[i])) && f(k, n)
                }
            ...
            function u(a, b, c, e) {
                ...
                for (var h = a.aoColumns,
                         i = 0,
                         j = h.length; j > i; i++) c && z(a, f, i, y(a, f, i)),
                    h[i].sType = null;
            ...
            function y(a, b, d, e) {
                ...
                if (j === c) return a.iDrawError != f && null === i && (Kb(a, 0, "Requested unknown parameter " + ("function" == typeof g.mData ? "{function}": "'" + g.mData + "'") + " for row " + b, 4), a.iDrawError = f),
                    i;
                    ...
                    if ("" !== d) for (var j = A(d), k = 0, l = j.length; l > k; k++) {
                        if (f = j[k].match(tc), g = j[k].match(uc), f) {
                            ...
                            "" !== j[k] && (a = a[j[k]]),
                                ...
                                i = j.join(".");
                            for (var m = 0,
                                     n = a.length; n > m; m++) h.push(e(a[m], b, i));
                            var o = f[0].substring(1, f[0].length - 1);
                            a = "" === o ? h: h.join(o);
                            break
                        }
                        if (g) j[k] = j[k].replace(uc, ""),
                            a = a[j[k]]();
                        else {
            ...
            function C(a) {
                ...
                var b = function(a, d, e) {
                    for (var f, g, h, i, j, k = A(e), l = k[k.length - 1], m = 0, n = k.length - 1; n > m; m++) {
                        ...
                        h && (k[m] = k[m].replace(uc, ""), a = a[k[m]](d)),
            ...
            function F(a, b, d) {
                for (var e = -1,
                         f = 0,
                         g = a.length; g > f; f++) a[f] == b ? e = f: a[f] > b && a[f]--; - 1 != e && d === c && a.splice(e, 1)
            }
            function G(a, b, d, e) {
            ...
            function H(a, b, e, f) {
                ...
                if (k) for (; k;) g = k.nodeName.toUpperCase(),
                ("TD" == g || "TH" == g) && (p(k), j.push(k)),
                    k = k.nextSibling;
                else {
                    j = b.anCells;
                    for (var q = 0,
                             r = j.length; r > q; q++) p(j[q])
                }
                return {
                    data: f,
                    cells: j
            ...
            function I(a, c, d, e) {
                var f, g, h, i, j, k = a.aoData[c],
                    ...
                    m = [];
                if (null === k.nTr) {
                    for (f = d || b.createElement("tr"), k.nTr = f, k.anCells = m, f._DT_RowIndex = c, J(k), i = 0, j = a.aoColumns.length; j > i; i++) h = a.aoColumns[i],
            ...
            function J(a) {
                ...
                if (b) {
                    if (c.DT_RowId && (b.id = c.DT_RowId), c.DT_RowClass) {
                        ...
                        a.__rowc = a.__rowc ? rc(a.__rowc.concat(e)) : e,
            ...
            function K(a) {
                var b, c, e, f, g, h = a.nTHead,
                    ...
                    k = a.oClasses,
                    l = a.aoColumns;
                for (j && (f = d("<tr/>").appendTo(h)), b = 0, c = l.length; c > b; b++) g = l[b],
                    e = d(g.nTh).addClass(g.sClass),
                j && e.appendTo(f),
                a.oFeatures.bSort && (e.addClass(g.sSortingClass), g.bSortable !== !1 && (e.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Eb(a, g.nTh, b))),
                ...
                if (j && P(a.aoHeader, h), d(h).find(">tr").attr("role", "row"), d(h).find(">tr>th, >tr>td").addClass(k.sHeaderTH), d(i).find(">tr>th, >tr>td").addClass(k.sFooterTH), null !== i) {
                    var m = a.aoFooter[0];
                    for (b = 0, c = m.length; c > b; b++) g = l[b],
                        g.nTf = m[b].cell,
                    g.sClass && d(g.nTf).addClass(g.sClass)
                }
            }
            function L(a, b, e) {
                ...
                if (b) {
                    ...
                    for (f = 0, g = o.length; g > f; f++) {
                        ...
                        for (h = 0, i = o[f].length; i > h; h++) if (m = 1, n = 1, p[f][h] === c) {
                            for (l.appendChild(o[f][h].cell), p[f][h] = 1; o[f + m] !== c && o[f][h].cell == o[f + m][h].cell;) p[f + m][h] = 1,
                                m++;
            ...
            function M(a) {
                ...
                var e = [],
                    ...
                    l = a.aiDisplay;
                a.bDrawing = !0,
                j !== c && -1 !== j && (a._iDisplayStart = k ? j: j >= a.fnRecordsDisplay() ? 0 : j, a.iInitDisplayStart = -1);
                ...
                if (0 !== l.length) for (var o = k ? 0 : m, p = k ? a.aoData.length: n, r = o; p > r; r++) {
                    ...
                    Pb(a, "aoRowCallback", null, [u, t._aData, f, r]),
                        e.push(u),
                        f++
                } else {
                    var w = i.sZeroRecords;
                    1 == a.iDraw && "ajax" == Sb(a) ? w = i.sLoadingRecords: i.sEmptyTable && 0 === a.fnRecordsTotal() && (w = i.sEmptyTable),
                        e[0] = d("<tr/>", {
                            "class": h ? g[0] : ""
                        }).append(d("<td />", {
                            valign: "top",
                ...
                Pb(a, "aoHeaderCallback", "header", [d(a.nTHead).children("tr")[0], D(a), m, n, l]),
                    Pb(a, "aoFooterCallback", "footer", [d(a.nTFoot).children("tr")[0], D(a), m, n, l]);
                var x = d(a.nTBody);
                x.children().detach(),
                    x.append(d(e)),
                    Pb(a, "aoDrawCallback", "draw", [a]),
                    a.bSorted = !1,
                    a.bFiltered = !1,
                    a.bDrawing = !1
            }
            ...
            function O(a) {
                ...
                for (var h, i, j, k, l, m, n = a.sDom.split(""), o = 0; o < n.length; o++) {
                    ...
                    else if (0 !== Wb.ext.feature.length) for (var q = Wb.ext.feature,
                                                                   r = 0,
                                                                   s = q.length; s > r; r++) if (i == q[r].cFeature) {
                        h = q[r].fnInit(a);
                        break
                    }
                    if (h) {
            ...
            function R(a, b, c) {
                ...
                a.oAjaxData = b,
                    Pb(a, null, "preXhr", [a, b]),
                    a.fnServerData ? a.fnServerData.call(i, a.sAjaxSource, d.map(b,
                        function(a, b) {
                            return {
                                name: b,
                                value: a
            ...
            function S(a) {
                return a.bAjaxDataGet ? (a.iDraw++, ob(a, !0), R(a, T(a),
                    function(b) {
                        U(a, b)
                    }), !1) : !0
            }
            ...
            function W(a) {
                ...
                var k = d("<div/>", {
                    ...
                    n = d("input", k).val(g.sSearch).attr("placeholder", f.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", m ? tb(l, m) : l).bind("keypress.DT",
                        function(a) {
                            return 13 == a.keyCode ? !1 : void 0
                        }).attr("aria-controls", e);
                return d(a.nTable).on("search.dt.DT",
                    function(c, d) {
                        if (a === d) try {
            ...
            function Y(a) {
                for (var b, c, d = Wb.ext.search,
                         e = a.aiDisplay,
                         f = 0,
                         g = d.length; g > f; f++) {
                    for (var h = [], i = 0, j = e.length; j > i; i++) c = e[i],
                        b = a.aoData[c],
                    d[f](a, b._aFilterData, c, b._aData, i) && h.push(c);
                    e.length = 0,
                        e.push.apply(e, h)
                }
            }
            function Z(a, b, c, d, e, f) {
                if ("" !== b) for (var g, h = a.aiDisplay,
                                       i = _(b, d, e, f), j = h.length - 1; j >= 0; j--) g = a.aoData[h[j]]._aFilterData[c],
                i.test(g) || h.splice(j, 1)
            }
            ...
            function hb(a) {
                ...
                if (!a.bInitialised) return void setTimeout(function() {
                    ...
                    200);
                for (O(a), K(a), L(a, a.aoHeader), L(a, a.aoFooter), ob(a, !0), g.bAutoWidth && sb(a), b = 0, c = f.length; c > b; b++) d = f[b],
                d.sWidth && (d.nTh.style.width = yb(d.sWidth));
                N(a);
                var h = Sb(a);
                "ssp" != h && ("ajax" == h ? R(a, [],
                    function(c) {
            ...
            function ib(a, b) {
                a._bInitComplete = !0,
                b && n(a),
                    Pb(a, "aoInitComplete", "init", [a, b])
            }
            function jb(a, b) {
                var c = parseInt(b, 10);
                a._iDisplayLength = c,
                    Qb(a),
                    Pb(a, null, "length", [a, c])
            }
            function kb(a) {
                for (var b = a.oClasses,
                         c = a.sTableId,
                         e = a.aLengthMenu,
                         f = d.isArray(e[0]), g = f ? e[0] : e, h = f ? e[1] : e, i = d("<select/>", {
                        name: c + "_length",
                        "aria-controls": c,
                ...
                return a.aanFeatures.l || (l[0].id = c + "_length"),
                    ...
                    d("select", l).val(a._iDisplayLength).bind("change.DT",
                        function() {
                            jb(a, d(this).val()),
                                M(a)
                        }),
                    d(a.nTable).bind("length.dt.DT",
                        function(b, c, e) {
            ...
            function qb(a) {
                ...
                if (D.children("thead, tfoot").remove(), g = C.clone().prependTo(D), b = C.find("tr"), e = g.find("tr"), g.find("th, td").removeAttr("tabindex"), G && (h = G.clone().prependTo(D), c = G.find("tr"), f = h.find("tr")), m || (y.width = "100%", r[0].style.width = "100%"), d.each(Q(a, g),
                        function(b, c) {
                            i = o(a, b),
            ...
            function sb(b) {
                var c, e, f, g, h, i = b.nTable,
                    ...
                    v = i.parentNode,
                    w = !1;
                for (c = 0; c < s.length; c++) e = j[s[c]],
                null !== e.sWidth && (e.sWidth = ub(e.sWidthOrig, v), w = !0);
                if (w || m || l || p != q(b) || p != t.length) {
                    ...
                    for (t = Q(b, x.find("thead")[0]), c = 0; c < s.length; c++) e = j[s[c]],
                        t[c].style.width = null !== e.sWidthOrig && "" !== e.sWidthOrig ? yb(e.sWidthOrig) : "";
                    if (b.aoData.length) for (c = 0; c < s.length; c++) f = s[c],
                        e = j[f],
                        d(wb(b, f)).clone(!1).append(e.sContentPadding).appendTo(y);
                    if (x.appendTo(v), m && o ? x.width(o) : m ? (x.css("width", "auto"), x.width() < v.offsetWidth && x.width(v.offsetWidth)) : l ? x.width(v.offsetWidth) : u && x.width(u), vb(b, x[0]), m) {
                        ...
                        for (c = 0; c < s.length; c++) e = j[s[c]],
                            h = d(t[c]).outerWidth(),
                            z += null === e.sWidthOrig ? h: parseInt(e.sWidth, 10) + h - d(t[c]).width();
                        x.width(yb(z)),
                            i.style.width = yb(z)
                    }
                    for (c = 0; c < s.length; c++) e = j[s[c]],
                        g = d(t[c]).width(),
                    g && (e.sWidth = yb(g));
                    i.style.width = yb(x.css("width")),
                        x.remove()
                } else for (c = 0; p > c; c++) j[c].sWidth = yb(t.eq(c).width());
                u && (i.style.width = yb(u)),
                !u && !m || b._reszEvt || (d(a).bind("resize.DT-" + b.sInstance, tb(function() {
                    n(b)
                })), b._reszEvt = !0)
            }
            function tb(a, b) {
            ...
            function xb(a, b) {
                for (var c, d = -1,
                         e = -1,
                         f = 0,
                         g = a.aoData.length; g > f; f++) c = y(a, f, b, "display") + "",
                    c = c.replace(xc, ""),
            ...
            function Ab(a) {
                ...
                for (d.isArray(m) && p(m), n && m.pre && p(m.pre), p(a.aaSorting), n && m.post && p(m.post), b = 0; b < o.length; b++) for (j = o[b][0], g = l[j].aDataSort, e = 0, f = g.length; f > e; e++) h = g[e],
                    i = l[h].sType || "string",
            ...
            function Bb(a) {
                var b, c, d, e, f, g = [],
                    ...
                    j = (a.aoColumns, 0),
                    k = a.aiDisplayMaster;
                for (s(a), f = Ab(a), b = 0, c = f.length; c > b; b++) e = f[b],
                e.formatter && j++,
                    Gb(a, e.col);
            ...
            function Cb(a) {
                for (var b, c, d = a.aoColumns,
                         e = Ab(a), f = a.oLanguage.oAria, g = 0, h = d.length; h > g; g++) {
                    var i = d[g],
                        j = i.asSorting,
            ...
            function Db(a, b, e, f) {
                ...
                if ("number" == typeof i[0] && (i = a.aaSorting = [i]), e && a.oFeatures.bSortMulti) {
                    var l = d.inArray(b, mc(i, "0")); - 1 !== l ? (g = k(i[l], !0), null === g ? i.splice(l, 1) : (i[l][1] = j[g], i[l]._idx = g)) : (i.push([b, j[0], 0]), i[i.length - 1]._idx = 0)
            ...
            function Fb(a) {
                ...
                if (i.bSort && i.bSortClasses) {
                    for (b = 0, c = f.length; c > b; b++) e = f[b].src,
                        d(mc(a.aoData, "anCells", e)).removeClass(g + (2 > b ? b + 1 : 3));
                    for (b = 0, c = h.length; c > b; b++) e = h[b].src,
                        d(mc(a.aoData, "anCells", e)).addClass(g + (2 > b ? b + 1 : 3))
                }
                a.aLastSort = h
            }
            function Gb(a, b) {
                ...
                for (var f, g, h = Wb.ext.type.order[d.sType + "-pre"], i = 0, j = a.aoData.length; j > i; i++) f = a.aoData[i],
                f._aSortData || (f._aSortData = []),
                (!f._aSortData[b] || e) && (g = e ? c[i] : y(a, i, b, "sort"), f._aSortData[b] = h ? h(g) : g)
            }
            function Hb(a) {
                if (a.oFeatures.bStateSave && !a.bDestroying) {
                    ...
                    Pb(a, "aoStateSaveParams", "stateSaveParams", [a, b]),
                        a.oSavedState = b,
                    ...
                    if (f && f.time) {
                        ...
                        if ( - 1 === d.inArray(!1, g)) {
                            ...
                            if (! (h > 0 && f.time < +new Date - 1e3 * h) && e.length === f.columns.length) {
                                for (a.oLoadedState = d.extend(!0, {},
                                    f), a._iDisplayStart = f.start, a.iInitDisplayStart = f.start, a._iDisplayLength = f.length, a.aaSorting = [], d.each(f.order,
                                    function(b, c) {
                                        a.aaSorting.push(c[0] >= e.length ? [0, c[1]] : c)
                                    }), d.extend(a.oPreviousSearch, db(f.search)), b = 0, c = f.columns.length; c > b; b++) {
                                    var i = f.columns[b];
                                    e[b].bVisible = i.visible,
                                        d.extend(a.aoPreSearchCols[b], db(i.search))
                                }
            ...
            function Lb(a, b, e, f) {
                return d.isArray(e) ? void d.each(e,
                    function(c, e) {
            ...
            function Pb(a, b, c, e) {
                var f = [];
                return b && (f = d.map(a[b].slice().reverse(),
                    function(b) {
            ...
            function Tb(a, b) {
                var c = [],
                    d = Uc.numbers_length,
                    e = Math.floor(d / 2);
                return d >= b ? c = oc(0, b) : e >= a ? (c = oc(0, d - 2), c.push("ellipsis"), c.push(b - 1)) : a >= b - 1 - e ? (c = oc(b - (d - 2), b), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0)) : (c = oc(a - 1, a + 2), c.push("ellipsis"), c.push(b - 1), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0)),
                    c.DT_el = "span",
                    c
            }
            function Ub(a) {
                d.each({
                    ...
                    function(b, c) {
                        ...
                        b.match(/^html\-/) && (Xb.type.search[b + a] = Xb.type.search.html)
                    })
            }
            function Vb(a) {
                return function() {
            ...
            var Wb, Xb, Yb, Zb, $b, _b = {},
                ...
                ic = function(a, b) {
                    return _b[b] || (_b[b] = new RegExp(ab(b), "g")),
                        "string" == typeof a && "." !== b ? a.replace(/\./g, "").replace(_b[b], ".") : a
                },
                jc = function(a, b, c) {
                    var d = "string" == typeof a;
                    return b && d && (a = ic(a, b)),
                    c && d && (a = a.replace(fc, "")),
                    gc(a) || !isNaN(parseFloat(a)) && isFinite(a)
                },
                kc = function(a) {
                ...
                mc = function(a, b, d) {
                    var e = [],
                        f = 0,
                        g = a.length;
                    if (d !== c) for (; g > f; f++) a[f] && a[f][b] && e.push(a[f][b][d]);
                ...
                nc = function(a, b, d, e) {
                    var f = [],
                        g = 0,
                        h = b.length;
                    if (e !== c) for (; h > g; g++) a[b[g]][d] && f.push(a[b[g]][d][e]);
                    else for (; h > g; g++) f.push(a[b[g]][d]);
                    return f
                },
                oc = function(a, b) {
                    var d, e = [];
            ...
            Wb = function(a) {
                this.$ = function(a, b) {
                    ...
                    this.fnClearTable = function(a) {
                        var b = this.api(!0).clear(); (a === c || a) && b.draw()
                    },
                    ...
                    this.fnPageChange = function(a, b) {
                        var d = this.api(!0).page(a); (b === c || b) && d.draw(!1)
                    },
                    this.fnSetColumnVis = function(a, b, d) {
                        var e = this.api(!0).column(a).visible(b); (d === c || d) && e.columns.adjust().draw()
                    },
                ...
                var b = this,
                    ...
                    k = this.length;
                e && (a = {}),
                    this.oApi = this.internal = Xb.internal;
                ...
                return this.each(function() {
                    ...
                    p.aLengthMenu && !p.iDisplayLength && (p.iDisplayLength = d.isArray(p.aLengthMenu[0]) ? p.aLengthMenu[0][0] : p.aLengthMenu[0]),
                        p = Mb(d.extend(!0, {},
                            w), p),
                        Lb(A.oFeatures, p, ["bPaginate", "bLengthChange", "bFilter", "bSort", "bSortMulti", "bInfo", "bProcessing", "bAutoWidth", "bSortClasses", "bServerSide", "bDeferRender"]),
                        Lb(A, p, ["asStripeClasses", "ajax", "fnServerData", "fnFormatNumber", "sServerMethod", "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "sAjaxSource", "sAjaxDataProp", "iStateDuration", "sDom", "bSortCellsTop", "iTabIndex", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", ["iCookieDuration", "iStateDuration"], ["oSearch", "oPreviousSearch"], ["aoSearchCols", "aoPreSearchCols"], ["iDisplayLength", "_iDisplayLength"], ["bJQueryUI", "bJUI"]]),
                        Lb(A.oScroll, p, [["sScrollX", "sX"], ["sScrollXInner", "sXInner"], ["sScrollY", "sY"], ["bScrollCollapse", "bCollapse"]]),
                        Lb(A.oLanguage, p, "fnInfoCallback"),
                        Ob(A, "aoDrawCallback", p.fnDrawCallback, "user"),
                        Ob(A, "aoServerParams", p.fnServerParams, "user"),
                        Ob(A, "aoStateSaveParams", p.fnStateSaveParams, "user"),
                        Ob(A, "aoStateLoadParams", p.fnStateLoadParams, "user"),
                        Ob(A, "aoStateLoaded", p.fnStateLoaded, "user"),
                        Ob(A, "aoRowCallback", p.fnRowCallback, "user"),
                        Ob(A, "aoRowCreatedCallback", p.fnCreatedRow, "user"),
                        Ob(A, "aoHeaderCallback", p.fnHeaderCallback, "user"),
                        Ob(A, "aoFooterCallback", p.fnFooterCallback, "user"),
                        Ob(A, "aoInitComplete", p.fnInitComplete, "user"),
                        Ob(A, "aoPreDrawCallback", p.fnPreDrawCallback, "user");
                    var B = A.oClasses;
                    ...
                    var E = A.asStripeClasses,
                        F = d("tbody tr:eq(0)", this); - 1 !== d.inArray(!0, d.map(E,
                        function(a) {
                            return F.hasClass(a)
                        })) && (d("tbody tr", this).removeClass(E.join(" ")), A.asDestroyStripes = E.slice());
                    var G, I = [],
                        J = this.getElementsByTagName("thead");
                    if (0 !== J.length && (P(A.aoHeader, J[0]), I = Q(A)), null === p.aoColumns) for (G = [], q = 0, n = I.length; n > q; q++) G.push(null);
                    else G = p.aoColumns;
                    for (q = 0, n = G.length; n > q; q++) l(A, I ? I[q] : null);
                    if (t(A, p.aoColumnDefs, G,
                            function(a, b) {
                                m(A, a, b)
                            }), F.length) {
                        var K = function(a, b) {
                        ...
                        d.each(H(A, F[0]).cells,
                            function(a, b) {
                                var d = A.aoColumns[a];
                                if (d.mData === a) {
                                    var e = K(b, "sort") || K(b, "order"),
                                        f = K(b, "filter") || K(b, "search"); (null !== e || null !== f) && (d.mData = {
                                        _: a + ".display",
                        ...
                        function() {
                            if (A.bSorted) {
                                ...
                                d.each(a,
                                    ...
                                    Pb(A, null, "order", [A, a, b]),
                                    Cb(A)
                            }
                        }),
                        Ob(A, "aoDrawCallback",
                            function() { (A.bSorted || "ssp" === Sb(A) || L.bDeferRender) && Fb(A)
                            },
                            "sc"),
                        j(A);
                    ...
                    0 === O.length && (O = d("<thead/>").appendTo(this)),
                        A.nTHead = O[0];
                    var R = d(this).children("tbody");
                    0 === R.length && (R = d("<tbody/>").appendTo(this)),
                        A.nTBody = R[0];
                    var S = d(this).children("tfoot");
                    if (0 === S.length && N.length > 0 && ("" !== A.oScroll.sX || "" !== A.oScroll.sY) && (S = d("<tfoot/>").appendTo(this)), 0 === S.length || 0 === S.children().length ? d(this).addClass(B.sNoFooter) : S.length > 0 && (A.nTFoot = S[0], P(A.aoFooter, A.nTFoot)), p.aaData) for (q = 0; q < p.aaData.length; q++) u(A, p.aaData[q]);
            ...
            Yb = function(a, b) {
                ...
                Yb.prototype = {
                    ...
                    each: function(a) {
                        for (var b = 0,
                                 c = this.length; c > b; b++) a.call(this, this[b], b, this);
                        return this
                    },
                    eq: function(a) {
                        var b = this.context;
                    ...
                    filter: function(a) {
                        var b = [];
                        if (zc.filter) b = zc.filter.call(this, a, this);
                        else for (var c = 0,
                                      d = this.length; d > c; c++) a.call(this, this[c], c, this) && b.push(this[c]);
                    ...
                    iterator: function(a, b, d, e) {
                        ...
                        for ("string" == typeof a && (e = d, d = b, b = a, a = !1), g = 0, h = o.length; h > g; g++) {
                            var q = new Yb(o[g]);
                            if ("table" === b) f = d.call(q, o[g], g),
                            f !== c && n.push(f);
                            else if ("columns" === b || "rows" === b) f = d.call(q, o[g], this[g], g),
                            f !== c && n.push(f);
                            else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) for (l = this[g], "column-rows" === b && (k = Gc(o[g], p.opts)), i = 0, j = l.length; j > i; i++) m = l[i],
                                f = "cell" === b ? d.call(q, o[g], m.row, m.column, g, i) : d.call(q, o[g], m, g, i, k),
                            f !== c && n.push(f)
                        }
                        if (n.length || e) {
                            var r = new Yb(o, a ? n.concat.apply([], n) : n),
                                s = r.selector;
                    ...
                    map: function(a) {
                        var b = [];
                        if (zc.map) b = zc.map.call(this, a, this);
                        else for (var c = 0,
                                      d = this.length; d > c; c++) b.push(a.call(this, this[c], c));
                        return new Yb(this.context, b)
                    },
                    pluck: function(a) {
                    ...
                    if (b && (b instanceof Yb || b.__dt_wrapper)) {
                        var e, f, g, h = function(a, b, c) {
                            return function() {
                                ...
                                return Yb.extend(d, d, c.methodExt),
                                    d
                            }
                        };
                        for (e = 0, f = c.length; f > e; e++) g = c[e],
                            b[g.name] = "function" == typeof g.val ? h(a, g.val, g) : d.isPlainObject(g.val) ? {}: g.val,
                            b[g.name].__dt_wrapper = !0,
                            Yb.extend(a, b[g.name], g.propExt)
                    }
                },
                Yb.register = Zb = function(a, b) {
                    if (d.isArray(a)) for (var c = 0,
                                               e = a.length; e > c; c++) Yb.register(a[c], b);
                    else {
                        var f, g, h, i, j = a.split("."),
                            k = yc,
                            l = function(a, b) {
                                for (var c = 0,
                                         d = a.length; d > c; c++) if (a[c].name === b) return a[c];
                                return null
                            };
            ...
            Zb("tables()",
                ...
                $b("tables().containers()", "table().container()",
                    function() {
                        return this.iterator("table",
                            function(a) {
                ...
                Zb("page()",
                    function(a) {
                        return a === c ? this.page.info().page: this.iterator("table",
                            function(b) {
                                mb(b, a)
                            })
                    }),
                ...
                Zb("page.len()",
                    function(a) {
                        return a === c ? 0 !== this.context.length ? this.context[0]._iDisplayLength: c: this.iterator("table",
                            function(b) {
                                jb(b, a)
                            })
                    });
            var Cc = function(a, b, c) {
                if ("ssp" == Sb(a) ? N(a, b) : (ob(a, !0), R(a, [],
                        function(c) {
                            E(a);
            ...
            Zb("ajax.json()",
                ...
                Zb("ajax.url()",
                    function(a) {
                        var b = this.context;
                        return a === c ? 0 === b.length ? c: (b = b[0], b.ajax ? d.isPlainObject(b.ajax) ? b.ajax.url: b.ajax: b.sAjaxSource) : this.iterator("table",
                            function(b) {
            ...
            var Dc = function(a, b) {
                    var e, f, g, h, i, j, k = [],
                        l = typeof a;
                    for (a && "string" !== l && "function" !== l && a.length !== c || (a = [a]), g = 0, h = a.length; h > g; g++) for (f = a[g] && a[g].split ? a[g].split(",") : [a[g]], i = 0, j = f.length; j > i; i++) e = b("string" == typeof f[i] ? d.trim(f[i]) : f[i]),
                    e && e.length && k.push.apply(k, e);
                    return k
                },
                Ec = function(a) {
                    return a || (a = {}),
                ...
                Fc = function(a) {
                    for (var b = 0,
                             c = a.length; c > b; b++) if (a[b].length > 0) return a[0] = a[b],
                        a.length = 1,
                ...
                Gc = function(a, b) {
                    ...
                    if ("current" == l) for (c = a._iDisplayStart, e = a.fnDisplayEnd(); e > c; c++) g.push(h[c]);
                    else if ("current" == k || "applied" == k) g = "none" == j ? i.slice() : "applied" == j ? h.slice() : d.map(i,
                        function(a) {
                ...
                Hc = function(a, b, c) {
                    return Dc(b,
                        function(b) {
                            ...
                            if (!b) return f;
                            if ("function" == typeof b) return d.map(f,
                                function(c) {
                                    var d = a.aoData[c];
            ...
            Zb("rows()",
                ...
                $b("rows().invalidate()", "row().invalidate()",
                    function(a) {
                        return this.iterator("row",
                            function(b, c) {
                                G(b, c, a)
                    ...
                    function() {
                        ...
                        return this.iterator("row",
                            function(b, c, e) {
                                ...
                                f.splice(c, 1);
                                for (var g = 0,
                                         h = f.length; h > g; g++) null !== f[g].nTr && (f[g].nTr._DT_RowIndex = g);
                        ...
                        var b = this.iterator("table",
                                function(b) {
                                    ...
                                    for (d = 0, e = a.length; e > d; d++) c = a[d],
                                        f.push(c.nodeName && "TR" === c.nodeName.toUpperCase() ? v(b, c)[0] : u(b, c));
                                    return f
                                },
                                1),
                            c = this.rows( - 1);
            ...
            var Ic = function(a, b, c, e) {
                    ...
                    if (d.isArray(c) || c instanceof d) for (var h = 0,
                                                                 i = c.length; i > h; h++) g(c[h], e);
                    else g(c, e);
                ...
                Lc = function(a) {
                    ...
                    mc(g, "_details").length > 0 && (b.on(d,
                        ...
                        function(b, c) {
                            if (a === c) for (var d, e = q(c), f = 0, h = g.length; h > f; f++) d = g[f],
                            d._details && d._details.children("td[colspan]").attr("colspan", e)
                        }), b.on(f,
                        function(c, d) {
                            if (a === d) for (var e = 0,
                                                  f = g.length; f > e; e++) g[e]._details && Jc(b, e)
                        }))
                },
                Mc = "",
                Nc = Mc + "row().child",
                ...
                Sc = function(a, b, e, f) {
                    ...
                    if (l.bVisible !== e) {
                        if (e) {
                            ...
                            for (h = 0, i = m.length; i > h; h++) j = m[h].nTr,
                                g = m[h].anCells,
                            j && j.insertBefore(g[b], g[o] || null)
                        } else d(mc(a.aoData, "anCells", b)).detach();
                        l.bVisible = e,
                            L(a, a.aoHeader),
                            L(a, a.aoFooter),
                        (f === c || f) && (n(a), (a.oScroll.sX || a.oScroll.sY) && qb(a)),
                            Pb(a, null, "column-visibility", [a, b, e]),
                            Hb(a)
                    }
                };
            Zb("columns()",
                ...
                $b("columns().header()", "column().header()",
                    function() {
                ...
                $b("columns().footer()", "column().footer()",
                    function() {
                        return this.iterator("column",
                            function(a, b) {
                ...
                $b("columns().data()", "column().data()",
                    function() {
                        return this.iterator("column-rows", Qc, 1)
                    }),
                $b("columns().dataSrc()", "column().dataSrc()",
                    function() {
                        return this.iterator("column",
                            function(a, b) {
                ...
                $b("columns().visible()", "column().visible()",
                    function(a, b) {
                        return this.iterator("column",
                            function(d, e) {
                ...
                $b("columns().indexes()", "column().index()",
                    function(a) {
                        return this.iterator("column",
                            function(b, c) {
            ...
            Zb("cells()",
                function(a, b, e) {
                    if (d.isPlainObject(a) && (typeof a.row !== c ? (e = b, b = null) : (e = a, a = null)), d.isPlainObject(b) && (e = b, b = null), null === b || b === c) return this.iterator("table",
                        function(b) {
                            return Tc(b, a, Ec(e))
                        });
                ...
                $b("cells().invalidate()", "cell().invalidate()",
                    function(a) {
                        return this.iterator("cell",
                            function(b, c, d) {
                                G(b, c, a, d)
                ...
                Zb("order()",
                    function(a, b) {
                        var e = this.context;
                        return a === c ? 0 !== e.length ? e[0].aaSorting: c: ("number" == typeof a ? a = [[a, b]] : d.isArray(a[0]) || (a = Array.prototype.slice.call(arguments)), this.iterator("table",
                            function(b) {
                                b.aaSorting = a.slice()
                            }))
                    }),
                ...
                Zb("search()",
                    function(a, b, e, f) {
                        var g = this.context;
                        return a === c ? 0 !== g.length ? g[0].oPreviousSearch.sSearch: c: this.iterator("table",
                            function(c) {
                                c.oFeatures.bFilter && X(c, d.extend({},
                                    c.oPreviousSearch, {
                                        sSearch: a + "",
                                        bRegex: null === b ? !1 : b,
                                        bSmart: null === e ? !0 : e,
                ...
                $b("columns().search()", "column().search()",
                    function(a, b, e, f) {
                        return this.iterator("column",
                            function(g, h) {
                ...
                Wb.isDataTable = Wb.fnIsDataTable = function(a) {
                    var b = d(a).get(0),
                        c = !1;
                    return d.each(Wb.settings,
                        function(a, d) { (d.nTable === b || d.nScrollHead === b || d.nScrollFoot === b) && (c = !0)
                        }),
                        c
                },
                Wb.tables = Wb.fnTables = function(a) {
                    return d.map(Wb.settings,
                        function(b) {
                        ...
                        return b = b || !1,
                            this.iterator("table",
                                function(c) {
                                    ...
                                    c.bDestroying = !0,
                                        Pb(c, "aoDestroyCallback", "destroy", [c]),
                                    b || new Yb(c).columns().visible(!0),
                ...
                Wb.defaults = {
                    ...
                    oLanguage: {
                        ...
                        sEmptyTable: "无可用数据",
                        sInfo: "显示从第 _START_ 条到第 _END_ 条记录",
                        sInfoEmpty: "无相关记录",
                        sInfoFiltered: "(从 _MAX_ 条记录中过滤获取)",
                        sInfoPostFix: "",
                        sDecimal: "",
                        sThousands: ",",
                                ...
                                n = function(b, c) {
                                    ...
                                    for (f = 0, o = c.length; o > f; f++) if (q = c[f], d.isArray(q)) {
                                        ...
                                        switch (i = "", j = "", q) {
                                            ...
                                            case "next":
                                                i = l.sNext,
                                                    j = q + (h - 1 > g ? "": " " + k.sPageButtonDisabled);
                                                break;
                                            case "last":
                                                i = l.sLast,
                                                    j = q + (h - 1 > g ? "": " " + k.sPageButtonDisabled);
            ...
            return d.extend(Xb.type.order, {
                ...
                d.fn.dataTable = Wb,
                d.fn.dataTableSettings = Wb.settings,
                d.fn.dataTableExt = Wb.ext,
