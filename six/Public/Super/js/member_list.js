jQuery(document).ready(function() {
    ...
    $('.audit-checked').click(function(e) {
        ...
        var href = "/index.php/Super/Member/auditBatch/ids" + '/' + ids;
        location.href = href;
    });
...
function getDateTimePicker(a){
    ...
    /*$.ajax({
        url:'/index.php/Super/Member/getStatus',
        method:'POST',
        data:{
            user_id: id
        },
        ...
        success:function(data){
            if(data['status']==200){
                $('#start_time_'+id).val(data['currentStatus']['start_time']);
                $('#over_time_'+id).val(data['currentStatus']['over_time']);
                $('#action_'+id).val(data['currentStatus']['action']);
            }
        }
    });*/
}
function changeStatus(a){
    ...
    $.ajax({
        url:'/index.php/Super/Member/changeStatus',
        method:'POST',
        data:{
            id    : user_id ,
            status: status,
