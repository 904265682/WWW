...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Diary/add" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <label class="col-sm-2 control-label no-padding-right" for="form-field-1">是否可以点击：</label>
                <div class="col-sm-3">
                    <div class="radio">
                        <label>
                            <input class="ace" checked name="checkon" type="radio" value="0">
                            <span class="lbl"> 不可点击</span>
                        </label>
                        <label>
                            <input class="ace" name="checkon" type="radio" value="1">
