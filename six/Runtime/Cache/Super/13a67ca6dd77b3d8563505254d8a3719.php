...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Security/Show" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <!-- #section:elements.form -->
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">站点名称：</label>
                <div class="col-sm-3">
                   <input type="text" name="site_name" value="<?php echo ($site_name); ?>" class="col-xs-10 col-sm-12" placeholder="站点名称">
                </div>
                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">网站根目录：</label>
                <div class="col-sm-3">
                   <input type="text" name="site_url" value="<?php echo ($site_url); ?>" class="col-xs-10 col-sm-12" placeholder="网站根目录">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right"  for="form-field-1">网站备案号：</label>
                <div class="col-sm-3">
                   <input type="text" name="icp" value="<?php echo ($icp); ?>" class="col-xs-10 col-sm-12" placeholder="请输入网站备案号">
                </div>

                <label class="col-sm-1 control-label no-padding-right"  for="form-field-1">网站版权信息：</label>
                <div class="col-sm-3">
                    <textarea name="copy" cols="41" rows="5"><?php echo ($copy); ?></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   <input type="text" name="title" value="<?php echo ($title); ?>" class="col-xs-10 col-sm-12" placeholder="标题">
                </div>
                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">标题附加字：</label>
                <div class="col-sm-3">
                   <input type="text" name="title_add" value="<?php echo ($title_add); ?>" class="col-xs-10 col-sm-12" placeholder="标题附加字">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">网站关键词：</label>
                <div class="col-sm-3">
                    <textarea name="keywords" cols="41" rows="5"><?php echo ($keywords); ?></textarea>
                </div>
                 <label class="col-sm-1 control-label no-padding-right" for="form-field-1">关键词描述：</label>
                <div class="col-sm-3">
                    <textarea name="description" cols="41" rows="5"><?php echo ($description); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="file" placeholder="" name="logo" class="col-xs-10 col-sm-9"  />
                    <br>
                    <br>
                    <?php if(!empty($logo)): ?><img width="150px" src="<?php echo (SITE_URL); ?>/<?php echo ($logo); ?>"><?php endif; ?>
                </div>

                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">网站二维码：</label>

                <div class="col-sm-2">
                    <input type="file" placeholder="" name="qr_code" class="col-xs-10 col-sm-9"  />
                    <br>
                    <br>
                    <?php if(!empty($qr_code)): ?><img width="150px" src="<?php echo (SITE_URL); ?>/<?php echo ($qr_code); ?>"><?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">网站banner图：</label>
                <div class="col-sm-2">
                    <input type="file" placeholder="" name="banner" class="col-xs-10 col-sm-9"  />
                    <br>
                    <br>
                    <?php if(!empty($banner)): ?><img width="150px" src="<?php echo (SITE_URL); ?>/<?php echo ($banner); ?>"><?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">前台第一个板块标题：</label>
                <div class="col-sm-2">
                   <input type="text" name="one_tt" value="<?php echo ($one_tt); ?>" class="col-xs-10 col-sm-12" placeholder="前台第一个板块标题">
                </div>
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">前台第一个板块内容：</label>
                <div class="col-sm-3">
                    <textarea name="one_cont" cols="41" rows="5"><?php echo ($one_cont); ?></textarea>
                </div>
            </div>
             <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">前台第二个板块标题：</label>
                <div class="col-sm-2">
                   <input type="text" name="two_tt" value="<?php echo ($two_tt); ?>" class="col-xs-10 col-sm-12" placeholder="前台第二个板块标题">
                </div>
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">前台第二个板块内容：</label>
                <div class="col-sm-3">
                    <textarea name="two_cont" cols="41" rows="5"><?php echo ($two_cont); ?></textarea>
                </div>
            </div>
             <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">前台第三个板块标题：</label>
                <div class="col-sm-2">
                   <input type="text" name="three_tt" value="<?php echo ($three_tt); ?>" class="col-xs-10 col-sm-12" placeholder="前台第三个板块标题">
                </div>
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">前台第三个板块内容：</label>
                <div class="col-sm-3">
                    <textarea name="three_cont" cols="41" rows="5"><?php echo ($three_cont); ?></textarea>
                </div>
            </div>
            <div class="form-group">
