...
<div id="toolbar" class="btn-group">
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="/six/Super/Links/add" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "/six/Super/Links/oneLinksDate",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
            {
                ...
                var a='<a href="/six/Super/Links/edit/id/'+value+'">修改</a>&nbsp;|&nbsp;<a href="/six/Super/Links/top/id/'+value+'">置顶</a>&nbsp;|&nbsp;<a href="/six/Super/Links/index/action/del/id/'+value+'" onclick=" return del()">删除</a>';
                    return a;
                },
                title: '操作',
            },
    ...
    $("#btn_delete").click(function(event) {
        ...
        $.post("<?php echo (SITE_URL); ?>/Super/Links/allDel", {id: ids}, function(data) {
            if(data==1){
...
<script type="text/javascript">
	...
	// 			ids.push([$(this).val()]);
	// 		});
	// 		var href = "/six/Super/Links/Index/id" + '/' + ids;
	// 		location.href = href;
	// 	});
