...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Links/add" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   <input type="text" name="link_name" class="col-xs-10 col-sm-12" placeholder="请输入链接名称">
                </div>
            ...
            <div class="form-group">
               ...
               <div class="col-sm-3">
                   <input type="text" name="link_addr" class="col-xs-10 col-sm-12" placeholder="请输入链接地址">
                </div>
            </div>
