...
<div id="sidebar" class="sidebar responsive">
	...
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="#" class="dropdown-toggle">
				<i class="menu-icon fa fa-pencil-square-o"></i>
				<span class="menu-text">下载列表管理 </span>
				<b class="arrow fa fa-angle-down"></b>
			</a>
			<b class="arrow"></b>
			<ul class="submenu">
				<li class="">
					<a href="<?php echo (SITE_URL); ?>/Super/">
						<i class="menu-icon fa fa-caret-right"></i>
						下载列表列表
					</a>
					<b class="arrow"></b>
    ...
    <li class="hidden">
        <a href="/six/Super/Diary/add">
            日记添加
        </a>
    </li>

    <li class="hidden">
        <a href="/six/Super/Diary/edit">
            日记修改
        </a>
    </li>
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Diary/edit/id/2" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <label class="col-sm-2 control-label no-padding-right" for="form-field-1">是否可以点击：</label>
                <div class="col-sm-3">
                    <div class="radio">
                        <label>
                            <input class="ace" <?php if(($data["checkon"]) == "0"): ?>checked<?php endif; ?> name="checkon" type="radio" value="0">
                            <span class="lbl"> 不可点击</span>
                        </label>
                        <label>
                            <input class="ace" <?php if(($data["checkon"]) == "1"): ?>checked<?php endif; ?> name="checkon" type="radio" value="1">
                            <span class="lbl"> 可以点击</span>
                        </label>
                    </div>
                </div>
            </div>
