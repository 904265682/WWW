...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Security/Information" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <!-- #section:elements.form -->
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right"  for="form-field-1">站长姓名：</label>
                <div class="col-sm-3">
                   <input type="text" name="name" value="<?php echo ($name); ?>" class="col-xs-10 col-sm-12" placeholder="请输入站长姓名">
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right"  for="form-field-1">站长职业：</label>
                <div class="col-sm-3">
                   <input type="text" name="profession" value="<?php echo ($profession); ?>" class="col-xs-10 col-sm-12" placeholder="请输入站长职业">
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">站长座右铭：</label>
                <div class="col-sm-3">
                   <input type="text" name="motto" value="<?php echo ($motto); ?>" class="col-xs-10 col-sm-12" placeholder="站长座右铭">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   <input type="text" name="qq" value="<?php echo ($qq); ?>" class="col-xs-10 col-sm-12" placeholder="站长qq">
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">交流群号码：</label>
                <div class="col-sm-3">
                   <input type="text" name="qqqun" value="<?php echo ($qqqun); ?>" class="col-xs-10 col-sm-12" placeholder="交流群号码">
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">交流群加群代码：</label>
                <div class="col-sm-3">
                <textarea placeholder="请输入交流群加群代码" name="quncreate" cols="40" rows="5"><?php echo ($quncreate); ?></textarea>
                </div>
            </div>
