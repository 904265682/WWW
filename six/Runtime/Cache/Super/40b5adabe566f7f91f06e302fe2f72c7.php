...
<div id="sidebar" class="sidebar responsive">
    ...
    <li class="hidden">
        <a href="/six/Super/Links/add">
            友情链接添加
        </a>
    </li>

    <li class="hidden">
        <a href="/six/Super/Links/edit">
            友情链接修改
        </a>
    </li>
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Links/edit/id/7" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   <input type="text" name="link_name" value="<?php echo ($data["link_name"]); ?>" class="col-xs-10 col-sm-12" placeholder="请输入链接名称">
                </div>
            ...
            <div class="form-group">
               ...
               <div class="col-sm-3">
                   <input type="text" name="link_addr" value="<?php echo ($data["link_addr"]); ?>" class="col-xs-10 col-sm-12" placeholder="请输入链接地址">
                </div>
            </div>
