...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form action="<?php echo (SITE_URL); ?>/Super/Security/PwRevise" class="form-horizontal" role="form" method="post">
			<!-- #section:elements.form -->
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">原密码</label>

				<div class="col-sm-4">
					<input type="password" name="old_pw" placeholder="请输入原密码" class="col-xs-10 col-sm-5" value="<?php echo ($info["show_order"]); ?>" />
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="password" name="new_pw1" placeholder="请输入新密码" class="col-xs-10 col-sm-5" value="<?php echo ($info["name"]); ?>" />
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="password" name="new_pw2" placeholder="请再次输入新密码" class="col-xs-10 col-sm-5" value="<?php echo ($info["name"]); ?>" />
				</div>
			</div>	
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">本次修改人</label>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">本次修改时间</label>
