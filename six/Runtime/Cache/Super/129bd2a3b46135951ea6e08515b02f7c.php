...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/MenuCont/link/mid/10" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <!-- #section:elements.form -->
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right"  for="form-field-1">跳转链接：</label>
                <div class="col-sm-3">
                   <input type="text" name="link" value="<?php echo ($link); ?>" class="col-xs-10 col-sm-12" placeholder="请输入跳转链接">
                </div>
            </div>
