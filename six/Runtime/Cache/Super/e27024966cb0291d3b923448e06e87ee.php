...
<div id="sidebar" class="sidebar responsive">
    ...
    <li class="hidden">
        <a href="/six/Super/Mess/add">
            留言添加
        </a>
    </li>

    <li class="hidden">
        <a href="/six/Super/Mess/edit">
            留言修改
        </a>
    </li>
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Mess/edit/id/10" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <label class="col-sm-2 control-label no-padding-right" for="form-field-1">显示状态：</label>
                ...
                <div class="col-sm-3">
                   <input type="text" name="reply_user" value="<?php echo ($data["reply_user"]); ?>" class="col-xs-10 col-sm-12" placeholder="请输入回复人">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">留言：</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1" >回复内容：</label><div class="col-sm-10"><script id="editor" type="text/plain" name="reply" style="width:800px;height:500px;"><?php echo ($data["reply"]); ?></script></div>
            </div>
            <script>
