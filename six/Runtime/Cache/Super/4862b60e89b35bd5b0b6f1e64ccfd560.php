...
<div id="toolbar" class="btn-group">
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="/six/Super/MenuCont/add/mid/<?php echo $_GET['mid'];?>" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "/six/Super/MenuCont/menuContDate/id/<?php echo ($mid); ?>",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
            {
                ...
                formatter:function(value,row,index){
                    if (value) {
                        var a='<img style="width:150px" src="<?php echo (SITE_URL); ?>/'+value+'">';
                    }else{
                        var a='无图片';
                    }
                    return a;
                ...
                field:'id',
                formatter:function(value,row,index){
                var a='<a href="/six/Super/MenuCont/edit/mid/<?php echo ($mid); ?>/id/'+value+'">修改</a>&nbsp;|&nbsp;<a href="/six/Super/MenuCont/top/mid/<?php echo ($mid); ?>/id/'+value+'">置顶</a>&nbsp;|&nbsp;<a href="/six/Super/MenuCont/index/mid/<?php echo ($mid); ?>/action/del/id/'+value+'" onclick=" return del()">删除</a>';
                    return a;
                },
                title: '操作',
            },
...
<script type="text/javascript">
	...
	// 			ids.push([$(this).val()]);
	// 		});
	// 		var href = "/six/Super/MenuCont/Index/id" + '/' + ids;
	// 		location.href = href;
	// 	});
