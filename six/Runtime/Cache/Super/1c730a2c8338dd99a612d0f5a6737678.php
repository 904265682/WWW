...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Down/add" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <!-- #section:elements.form -->
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">显示顺序：</label>
                <div class="col-sm-2">
                   <input type="text" name="show_order" value="<?php echo ($show_order); ?>" class="col-xs-10 col-sm-6" placeholder="显示顺序">
                </div>
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">隶属菜单：</label>
                <div class="col-sm-2">
                   <select name="menu_id">
                        <?php if(is_array($cd)): foreach($cd as $key=>$cd): ?><option value="<?php echo ($cd["id"]); ?>"><?php echo ($cd["menu_name"]); ?></option><?php endforeach; endif; ?>
                   </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   <input type="text" name="click_num" class="col-xs-10 col-sm-12" placeholder="请输入点击量">
                </div>
                 <label class="col-sm-1 control-label no-padding-right"  for="form-field-1">作者：</label>
                <div class="col-sm-3">
                   <input type="text" name="writer" class="col-xs-10 col-sm-12" placeholder="请输入作者">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   <input type="text" name="link" class="col-xs-10 col-sm-12" placeholder="云盘链接">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="cont" cols="110" rows="5"></textarea>
                </div>
            </div>
<!--             <div class="form-group">
