...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/MenuCont/pictext/mid/5" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">访问次数：</label>
                <div class="col-sm-3">
                   <input type="text" name="click_num" value="<?php echo ($data["click_num"]); ?>" class="col-xs-10 col-sm-8" placeholder="访问次数">
                </div>
            </div>
            <div class="form-group">
