...
<div id="sidebar" class="sidebar responsive">
    ...
    <li class="hidden">
        <a href="/six/Super/Menu/add">
            菜单添加
        </a>
    </li>

    <li class="hidden">
        <a href="/six/Super/Menu/edit">
            菜单修改
        </a>
    </li>
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Menu/edit/id/13" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <!-- #section:elements.form -->
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">显示顺序：</label>
                <div class="col-sm-2">
                   <input type="text" name="show_order" value="<?php echo ($data["show_order"]); ?>" class="col-xs-10 col-sm-4" >
                </div>
            </div>
            <div class="form-group">
            ...
            <?php if(($data["type"]) != "5"): ?><div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">隶属菜单：</label>
                <div class="col-sm-2">
                   <select name="up_id" id="one">
                       <option value="0" <?php if($data.up_id==0) echo selected; ?>>无上级菜单</option>
                       <?php if(is_array($info)): foreach($info as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $data["up_id"]): ?>selected<?php endif; ?>><?php echo ($vo["menu_name"]); ?></option><?php endforeach; endif; ?>
                   </select>
                </div>
            </div><?php endif; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                   <select name="type" id="two">
                       <option value="0" <?php if(($data["type"]) == "0"): ?>selected<?php endif; ?>>图文混排</option>
                       <option value="1" <?php if(($data["type"]) == "1"): ?>selected<?php endif; ?>>新闻列表</option>
                       <option value="2" <?php if(($data["type"]) == "2"): ?>selected<?php endif; ?>>图片列表</option>
                       <option value="3" <?php if(($data["type"]) == "3"): ?>selected<?php endif; ?>>跳转链接</option>
                       <option value="4" <?php if(($data["type"]) == "4"): ?>selected<?php endif; ?>>下载列表</option>
                       <option value="5" <?php if(($data["type"]) == "5"): ?>selected<?php endif; ?>>有下级菜单</option>
                   </select>
                </div>
            </div>
...
var nowTemp = new Date();
    ...
    document.getElementById("one").onchange=function(){
        var v = one.value;
        if (v==a[0].value) {
            two[5].style.display="block";
        }else{
            two[5].style.display="none";
        }
    }
