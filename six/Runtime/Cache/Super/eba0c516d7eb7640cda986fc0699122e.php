...
<div id="sidebar" class="sidebar responsive">
    ...
    <li class="hidden">
        <a href="/six/Super/Down/add">
            文件下载添加
        </a>
    </li>

    <li class="hidden">
        <a href="/six/Super/Down/edit">
            文件下载修改
        </a>
    </li>
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/six/Super/Down/edit/id/11" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">隶属菜单：</label>
                <div class="col-sm-2">
                   <select name="menu_id">
                        <?php if(is_array($cd)): foreach($cd as $key=>$cd): ?><option value="<?php echo ($cd["id"]); ?>" <?php if(($data["menu_id"]) == $cd["id"]): ?>selected<?php endif; ?>><?php echo ($cd["menu_name"]); ?></option><?php endforeach; endif; ?>
                   </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <div class="radio">
                        <label>
                            <input class="ace" <?php if(($data["state"]) == "1"): ?>checked<?php endif; ?> name="state" type="radio" value="1">
                            <span class="lbl"> 显示</span>
                        </label>
                        <label>
                            <input class="ace" <?php if(($data["state"]) == "0"): ?>checked<?php endif; ?> name="state" type="radio" value="0">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                   <input type="text" name="click_num" value="<?php echo ($data["click_num"]); ?>" class="col-xs-10 col-sm-12" placeholder="请输入点击量">
                </div>
                 <label class="col-sm-1 control-label no-padding-right"  for="form-field-1">作者：</label>
                <div class="col-sm-3">
                   <input type="text" name="writer" value="<?php echo ($data["writer"]); ?>" class="col-xs-10 col-sm-12" placeholder="请输入作者">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">云盘链接：</label>
                <div class="col-sm-3">
                   <input type="text" name="link" value="<?php echo ($data["link"]); ?>" class="col-xs-10 col-sm-12" placeholder="标签">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="file" placeholder="" name="file_url" class="col-xs-10 col-sm-12"  />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">摘要：</label>
                <div class="col-sm-10">
                    <textarea name="cont" cols="110" rows="5"><?php echo ($data["cont"]); ?></textarea>
                </div>
            </div>
            <div class="form-group">
