...
<div id="toolbar" class="btn-group">
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="/six/Super/Down/add" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "/six/Super/Down/oneDownDate",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
            {
                ...
                field:'id',
                formatter:function(value,row,index){
                var a='<a href="/six/Super/Down/edit/id/'+value+'">修改</a>&nbsp;|&nbsp;<a href="/six/Super/Down/top/id/'+value+'">置顶</a>&nbsp;|&nbsp;<a href="/six/Super/Down/index/action/del/id/'+value+'" onclick=" return del()">删除</a>';
                    return a;
                },
                title: '操作',
            },
    ...
    $("#btn_delete").click(function(event) {
        ...
        $.post("<?php echo (SITE_URL); ?>/Super/Down/allDel", {id: ids}, function(data) {
            if(data==1){
...
<script type="text/javascript">
	...
	// 			ids.push([$(this).val()]);
	// 		});
	// 		var href = "/six/Super/Down/Index/id" + '/' + ids;
	// 		location.href = href;
	// 	});
