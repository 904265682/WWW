...
<div id="toolbar" class="btn-group">
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="/six/Super/Menu/add" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "/six/Super/Menu/oneMenuDate",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
            {
                ...
                var a='<a href="/six/Super/Menu/edit/id/'+value+'">修改</a>|<a href="/six/Super/Menu/index/id/'+value+'" onclick=" return del()">删除</a>';
                    return a;
                },
                title: '操作',
            },
...
<script type="text/javascript">
	...
	// 			ids.push([$(this).val()]);
	// 		});
	// 		var href = "/six/Super/Menu/Index/id" + '/' + ids;
	// 		location.href = href;
	// 	});
