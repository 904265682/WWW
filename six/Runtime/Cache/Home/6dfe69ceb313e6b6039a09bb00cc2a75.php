...
<div class="main">
	<div class="page_left">	
		...
		<?php if(is_array($mlist)): foreach($mlist as $key=>$ml): if(empty($ml["pic"])): ?><li class="no_pic">
					<h2 class="title"><a href="<?php echo (SITE_URL); ?>/Home/Index/cont/id/<?php echo ($ml["id"]); ?>"><?php echo ($ml["title"]); ?></a></h2>
					<div class="date_hits">
						<span><?php echo ($ml["writer"]); ?></span>
						<span><?php $mlt = $ml['created_at']; echo substr($mlt,0,10);?></span>
						<span><a href="<?php echo ($site_url); ?>"><?php echo ($site_name); ?></a></span>
						<span class="hits"><i class="layui-icon" title="点击量"></i> <?php echo ($ml["click_num"]); ?> ℃</span>
						<p class="commonts"><i class="layui-icon" title="点击量">&#xe63a;</i> <span id="" class="cy_cmt_count">888</span></p>
					</div>
					<div class="desc"><?php echo ($ml["abstract"]); ?></div>
				</li>
			<?php else: ?>
				<li>
					<a href="<?php echo (SITE_URL); ?>/Home/Index/cont/id/<?php echo ($ml["id"]); ?>" class="pic"><img src="<?php echo (SITE_URL); ?>/<?php echo ($ml["pic"]); ?>" alt="<?php echo ($ml["title"]); ?>"></a>
					<h2 class="title"><a href="<?php echo (SITE_URL); ?>/Home/Index/cont/id/<?php echo ($ml["id"]); ?>"><?php echo ($ml["title"]); ?></a></h2>
					<div class="date_hits">
						<span><?php echo ($ml["writer"]); ?></span>
						<span><?php $mlt = $ml['created_at']; echo substr($mlt,0,10);?></span>
	...
	<div class="page_right">
		...
		<div class="hot_list">
			...
			<div class="mobile_qrcode wechat_qrcode trans_3">
				...
				<div id="qrcode" title="<?php echo ($site_url); ?>"><canvas width="324" height="324" style="display: none;"></canvas><img alt="Scan me!" src="<?php echo (SITE_URL); ?>/<?php echo ($qr_code); ?>" style="display: block;"></div>
			</div>
		</div>
	</div>
	<div class="clear"></div>
