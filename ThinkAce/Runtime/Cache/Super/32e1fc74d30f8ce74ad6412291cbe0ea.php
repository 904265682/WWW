...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form action="<?php echo (SITE_URL); ?>/Super/AuthAndRole/edit/auth_id/<?php echo ($info["auth_id"]); ?>" class="form-horizontal" role="form" method="post">
			<!-- #section:elements.form -->
<!-- 			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">显示序号</label>

				<div class="col-sm-1">
					<input type="text" name="show_order" class="col-xs-10 col-sm-5" value="<?php echo ($info["show_order"]); ?>" />
					<input type="hidden" name="id" class="col-xs-10 col-sm-5" value="<?php echo ($info["id"]); ?>" />
				</div>
			</div>	 -->
			<input type="hidden" name="auth_id" value="<?php echo ($info["auth_id"]); ?>">
		      ...
		      <div class="form-group">
		        ...
		        <div class="col-sm-9">
		          ...
		          <?php if(is_array($up_list)): foreach($up_list as $key=>$v): ?><option value="<?php echo ($v["auth_id"]); ?>" <?php if(($v["auth_id"]) == $info["auth_pid"]): ?>selected<?php endif; ?>><?php echo ($v["auth_name"]); ?></option><?php endforeach; endif; ?>
		          </select>
			...
			<div class="form-group">
		        ...
		        <div class="col-sm-6">
		          <input type="text" name="auth_name" class="col-xs-10 col-sm-5" value="<?php echo ($info["auth_name"]); ?>" />
			...
			<div class="form-group">
		        ...
		        <div class="col-sm-6">
		          <input type="text" name="auth_c" class="col-xs-10 col-sm-5" value="<?php echo ($info["auth_c"]); ?>" />
			...
			<div class="form-group">
		        ...
		        <div class="col-sm-6">
		          <input type="text" name="auth_a" class="col-xs-10 col-sm-5" value="<?php echo ($info["auth_a"]); ?>" />
			...
			<!-- <div class="form-group">
				...
				<div class="col-sm-9">
					<span class="help-inline col-xs-12 col-sm-7">
						<span class="middle"><?php echo ($info["add_user"]); ?></span>
					</span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">					
					<span class="help-inline col-xs-12 col-sm-7">
						<span class="middle"><?php echo ($info["updated_at"]); ?></span>
					</span>
				</div>
			</div> -->
