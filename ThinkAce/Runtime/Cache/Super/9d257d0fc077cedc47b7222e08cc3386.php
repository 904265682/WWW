...
<div id="sidebar" class="sidebar responsive">
	...
	<ul class="nav nav-list">
		...
		<li class="">
			...
			<ul class="submenu">
				...
				<li class="">
					...
					<ul class="submenu">
					<?php if(is_array($leftMenuData)): foreach($leftMenuData as $key=>$vo): if($vo["type"] != 3): ?><li class="">
								<a href="<?php echo (SITE_URL); ?>Super/MenuCont/index/up_id/<?php echo ($vo["id"]); ?>">
									<i class="menu-icon fa fa-caret-right"></i>
						...
						<?php else: ?>
							<li class="">
								...
								<b class="arrow"></b>
								<ul class="submenu">
									<?php if(is_array($twoMenuData)): foreach($twoMenuData as $key=>$vo1): if(is_array($vo1)): foreach($vo1 as $key=>$vo2): if(in_array($vo2['id'],$vo2)): ?><li class="">
													<a href="<?php echo (SITE_URL); ?>Super/MenuCont/index/up_id/<?php echo ($vo2["id"]); ?>">
														<i class="menu-icon fa fa-caret-right"></i>
														<?php echo ($vo2["menu_name"]); ?>
													</a>
													<b class="arrow"></b>
		...
		<li class="">
			<a href="#" class="dropdown-toggle">
				...
				<span class="menu-text">链接和宣传 </span>
    ...
    <li>
        <a href="/ThinkAce/Super/MenuCont/index/up_id/<?php echo ($up_id); ?>">
    ...
    <li class="hidden">
        <a href="/ThinkAce/Super/MenuCont/add/up_id/<?php echo ($up_id); ?>">
            菜单内容添加
        </a>
    </li>
    ...
    <li class="hidden">
        <a href="/ThinkAce/Super/MenuCont/edit/up_id/<?php echo ($up_id); ?>">
            菜单内容修改
        </a>
    </li>
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
              <form action="/ThinkAce/Super/MenuCont/edit/up_id/146/id/79" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <!-- #section:elements.form -->
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">显示顺序：</label>
                <div class="col-sm-2">
                   <input type="text" name="show_order" value="<?php echo ($data["show_order"]); ?>" class="col-xs-10 col-sm-4" placeholder="显示顺序">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right"  for="form-field-1">标题：</label>
                <div class="col-sm-4">
                   <input type="text" name="title" value="<?php echo ($data["title"]); ?>" class="col-xs-10 col-sm-8" placeholder="请输入标题">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1" >内容：</label><div class="col-sm-10"><script id="editor" name="cont" type="text/plain" style="width:800px;height:500px;"><?php echo ($data["cont"]); ?></script></div>
            </div>
            <script>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <div class="radio">
                        <label>
                            <input class="ace" name="state" <?php if($data["state"] == 1): ?>checked<?php endif; ?>  type="radio" value="1">
                            <span class="lbl"> 显示</span>
                        </label>
                        <label>
                            <input class="ace" name="state" <?php if($data["state"] == 0): ?>checked<?php endif; ?>  type="radio" value="0">
