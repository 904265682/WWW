...
<div id="toolbar" class="btn-group">
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="/ThinkAce/Super/MenuCont/add/up_id/<?php echo $_GET['up_id'];?>" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "/ThinkAce/Super/MenuCont/menuContDate/up_id/<?php echo ($up_id); ?>",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
            {
                ...
                var a='<a href="/ThinkAce/Super/MenuCont/edit/up_id/<?php echo ($up_id); ?>/id/'+value+'">修改</a>|<a href="/ThinkAce/Super/MenuCont/top/up_id/<?php echo ($up_id); ?>/id/'+value+'">置顶</a>|<a href="/ThinkAce/Super/MenuCont/index/up_id/<?php echo ($up_id); ?>/id/'+value+'" onclick=" return del()">删除</a>';
                    return a;
                },
                title: '操作',
            },
    ...
    $("#btn_delete").click(function(event) {
        ...
        $.post("<?php echo (SITE_URL); ?>Super/MenuCont/allDel", {id: ids}, function(data) {
            if(data==1){
...
<script type="text/javascript">
	...
	// 			ids.push([$(this).val()]);
	// 		});
	// 		var href = "/ThinkAce/Super/MenuCont/Index/id" + '/' + ids;
	// 		location.href = href;
	// 	});
