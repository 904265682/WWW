...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "<?php echo (SITE_URL); ?>Super/AuthAndRole/AuthDate",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            uniqueId: "atuh_id",                     //每一行的唯一标识，一般为主键列
            ...
            columns: [{
                ...
                var a='<a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/edit/auth_id/'+row['auth_id']+'">修改</a> &nbsp;丨&nbsp;<a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/index/auth_id/'+row['auth_id']+'">删除</a>';
                return a;
                },
                title: '操作',
            }, 
    ...
    $("#btn_delete").click(function(event) {
        ...
        $.post("<?php echo (SITE_URL); ?>Super/AuthAndRole/allDel", {id: ids}, function(data) {
            if(data==1){
