...
<div id="toolbar" class="btn-group">
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/roleAdd" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "<?php echo (SITE_URL); ?>Super/AuthAndRole/RoleDate",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [{
                ...
                var a='<a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/roleEdit/role_id/'+row['role_id']+'">修改</a> &nbsp;丨&nbsp;<a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/roleIndex/role_id/'+row['role_id']+'">删除</a>&nbsp;丨&nbsp;<a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/rolePower/role_id/'+row['role_id']+'">赋权</a>';
                return a;
                },
                title: '操作',
            },
    ...
    $("#btn_delete").click(function(event) {
        ...
        $.post("<?php echo (SITE_URL); ?>Super/AuthAndRole/allRoleDel", {id: ids}, function(data) {
            if(data==1){
                $table.bootstrapTable('remove', {field: 'role_id', values: ids});
            }
             if(data==0){
                alert("请先选择要删除的记录条数！");
            }
