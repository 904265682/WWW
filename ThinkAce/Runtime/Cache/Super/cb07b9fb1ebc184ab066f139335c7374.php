...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
       <form action="/ThinkAce/Super/Menu/edit/id/169" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                   <input type="text" value="<?php echo $data['menu_name'] ;?>" name="menu_name">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                   <select name="type" id="two">
                       <option value="0" <?php if($data['type'] == '0'){ echo selected; }?>>图文混排</option>
                       <option value="1" <?php if($data['type'] == '1'){ echo selected; }?>>新闻列表</option>
                       <!-- <option value="2" <?php if($data['type'] == '2'){ echo selected; }?>>图片列表</option> -->
                       <?php if(empty($_GET['up_id']) != false): ?><option value="3" <?php if($data['type'] == '3'){ echo selected; }?>>有下级菜单</option><?php endif; ?>
                   </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <div class="radio">
                        <label>
                            <input class="ace" checked name="state" type="radio" value="1" <?php if($data['state'] == '1'){ echo checked; }?>>
                            <span class="lbl"> 显示</span>
                        </label>
                        <label>
                            <input class="ace"  name="state" type="radio" value="0" <?php if($data['state'] == '0'){ echo checked; }?>>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">修改人：</label>
