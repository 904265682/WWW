...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form action="<?php echo (SITE_URL); ?>/Super/AuthAndRole/add" class="form-horizontal" role="form" method="post">
			<!-- #section:elements.form -->
<!-- 			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">显示序号</label>

				<div class="col-sm-1">
					<input type="text" name="show_order" class="col-xs-10 col-sm-5" value="<?php echo ($show_order); ?>" />
				</div>
			</div>	 -->
		      <div class="form-group">
		        ...
		        <div class="col-sm-9">
		          ...
		          <?php if(is_array($up_list)): foreach($up_list as $key=>$v): ?><option value="<?php echo ($v["auth_id"]); ?>"><?php echo ($v["auth_name"]); ?></option><?php endforeach; endif; ?>
		          </select>
			...
			<div class="form-group">
		        ...
		        <div class="col-sm-6">
		          <input type="text" name="auth_name" placeholder="请输入权限名称" class="col-xs-10 col-sm-5" />
			...
			<div class="form-group">
		        ...
		        <div class="col-sm-6">
		          <input type="text" name="auth_c" placeholder="请输入控制器名称" class="col-xs-10 col-sm-5" />

		        </div>
		    </div>

			<div class="form-group">
		        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">操作方法名称</label>

		        <div class="col-sm-6">
		          <input type="text" name="auth_a" placeholder="请输入操作方法名称" class="col-xs-10 col-sm-5" />
