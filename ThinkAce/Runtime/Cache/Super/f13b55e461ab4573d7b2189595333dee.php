...
<div id="sidebar" class="sidebar responsive">
    ...
    <div id="toolbar" class="btn-group">
        <button id="btn_add" type="button" class="btn btn-default">
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="<?php echo (SITE_URL); ?>Super/User/add" style="color:#333">新增</a>
        </button>
        ...
        var TableInit = function () {
            ...
            oTableInit.Init = function () {
                $('#tb_departments').bootstrapTable({
                    url: "<?php echo (SITE_URL); ?>Super/User/areaData",         //请求后台的URL（*）
                    method: 'get',                      //请求方式（*）
                    ...
                    // },
                    {
                        ...
                        formatter:function(value,row,index){
                            var a='<a href="<?php echo (SITE_URL); ?>Super/User/edit/id/'+value+'">密码修改</a> &nbsp;丨&nbsp;<a href="<?php echo (SITE_URL); ?>Super/User/powerEdit/id/'+value+'">角色修改</a> &nbsp;丨&nbsp;<a href="<?php echo (SITE_URL); ?>Super/User/index/id/'+value+'">删除</a>';
                            return a;
                        },
                        title: '操作',
                    },
            ...
            $("#btn_delete").click(function(event) {
                ...
                $.post("<?php echo (SITE_URL); ?>Super/User/alldel", {id: ids}, function(data) {
                    if(data==1){
