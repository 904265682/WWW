...
<div class="row">
  <div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form action="<?php echo (SITE_URL); ?>Super/User/add" class="form-horizontal" role="form" method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          ...
          <span class="help-inline col-xs-12 col-sm-7">
            <select name="role_id">
              <option>请选择角色</option>
              <?php if(is_array($role_list)): foreach($role_list as $key=>$v): ?><option value="<?php echo ($v["role_id"]); ?>"><?php echo ($v["role_name"]); ?></option><?php endforeach; endif; ?>
            </select>
          </span>
        </div>
      </div>
