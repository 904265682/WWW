...
<div id="toolbar" class="btn-group">
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/add" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "<?php echo (SITE_URL); ?>Super/AuthAndRole/AuthDate2",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            uniqueId: "auth_id",                     //每一行的唯一标识，一般为主键列
            ...
            columns: [{
                ...
                var a='<a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/edit/auth_id/'+row['auth_id']+'">修改</a> &nbsp;丨&nbsp;<a href="<?php echo (SITE_URL); ?>Super/AuthAndRole/index2/auth_id/'+row['auth_id']+'">删除</a>';
                return a;
                },
                title: '操作',
            }, 
    ...
    $("#btn_delete").click(function(event) {
        ...
        $.post("<?php echo (SITE_URL); ?>Super/AuthAndRole/allDel2", {id: ids}, function(data) {
            if(data==1){
                $table.bootstrapTable('remove', {field: 'auth_id', values: ids});
            }
            if(data==0){
                alert("请先选择要删除的记录条数！");
            }
