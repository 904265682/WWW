...
<div class="row">
  <div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form action="<?php echo (SITE_URL); ?>/Super/AuthAndRole/roleEdit/role_id/<?php echo ($_GET['role_id']); ?>" class="form-horizontal" role="form" method="post">
      <!-- #section:elements.form -->
      <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">角色名</label>

        <div class="col-sm-3">
          <input type="text" name="role_name" value="<?php echo ($info["role_name"]); ?>" class="col-xs-10 col-sm-5" />
        </div>
      </div>
