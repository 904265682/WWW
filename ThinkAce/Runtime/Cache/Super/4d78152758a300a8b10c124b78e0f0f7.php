...
<div id="toolbar" class="btn-group">
            <button id="btn_return" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span><a href="/ThinkAce/Super/Menu" style="color:#333"> 返回</a>
            </button>
            <button id="btn_add" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="/ThinkAce/Super/Menu/add/up_id/<?php echo $_GET['up_id'];?>" style="color:#333">新增</a>
            </button>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: "/ThinkAce/Super/Menu/twoMenuDate/up_id/<?php echo $_GET['up_id'];?>",         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
            {
                ...
                var a='<a href="/ThinkAce/Super/Menu/edit/up_id/'+row['up_id']+'/id/'+value+'">修改</a>|<a href="/ThinkAce/Super/Menu/index2/up_id/147/id/'+value+'" onclick=" return del()">删除</a>';
                return a;
                },
                title: '操作',
            },
